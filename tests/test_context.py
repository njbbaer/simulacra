...
#     assert context_instance.messages[-1] == {
#         "role": "user",
...
# def reset_conversation(context_instance):
#     context_instance.reset_conversation()
#     assert context_instance.messages == []
#     assert context_instance.conversation_cost == 0


# def test_trim_messages(context_instance):
#     context_instance.trim_messages(1)
#     assert len(context_instance.messages) == 1
#     assert context_instance.messages[-1]["content"] == "Hello, Alice!"
...
#     assert context_instance.conversation_facts == ["A fact"]


# def test_add_conversation_fact(context_instance):
#     context_instance.add_conversation_fact("Another fact")
#     assert context_instance.conversation_facts == [
#         "A fact",
#         "Another fact",
#     ]
